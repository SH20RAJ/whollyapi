<!DOCTYPE html>
<!-- saved from url=(0028)https://wholly-api.carrd.co/ -->
<html lang="en">
  <head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>WhollyAPI</title>
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <meta name="color-scheme" content="light only">
    <meta name="description" content="WhollyAPI - Get Free APIs of Many Website - Public or Scrapped - Use even from JavaScript">
    <meta property="og:site_name" content="WhollyAPI">
    <meta property="og:title" content="WhollyAPI">
    <meta property="og:type" content="website">
    <meta property="og:description" content="WhollyAPI - Get Free APIs of Many Website - Public or Scrapped - Use even from JavaScript">
    <meta property="og:image" content="https://wholly-api.carrd.co/assets/images/card.jpg?v=7c9c9dfb">
    <meta property="og:image:type" content="image/jpeg">
    <meta property="og:image:width" content="1280">
    <meta property="og:image:height" content="800">
    <meta property="og:url" content="https://wholly-api.carrd.co">
    <meta property="twitter:card" content="summary_large_image">
    <link rel="canonical" href="https://wholly-api.carrd.co/">
    <link href="./WhollyAPI_files/css" rel="stylesheet" type="text/css">
    <style>
      html,
      body,
      div,
      ...
      *:after {
      ...
      body:before {
        ...
        width: 100vw;
        z-index: 0;
        background-image: linear-gradient(to top, rgba(21, 20, 28, 0.871), rgba(21, 20, 28, 0.871)), url('assets/images/bg.svg?v=7c9c9dfb');
      ...
      #container01 {
        ...
        border-style: solid;
        background-image: linear-gradient(90deg, rgba(250, 144, 72, 0.949) 0%, rgba(255, 84, 115, 0.922) 100%), url('assets/images/container01.svg?v=7c9c9dfb');
        background-position: 0% 0%, center;
        background-repeat: repeat, no-repeat;
      ...
      hr.style1:before {
        width: 100%;
        border-top: solid 1px rgba(255, 255, 255, 0.149);
        height: 1px;
        margin-top: -0.5px;
      }
  ...
  <body class="is-ready">
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 40 40" display="none" width="0" height="0">
      <symbol id="icon-ecbd7520f72820fb3c1bfce19d8ed9ce" viewBox="0 0 40 40">
        <path d="M5.2,14.6l1.5-1.5c0.2-0.2,0.5-0.2,0.7,0l12.4,12.4l12.4-12.4c0.2-0.2,0.5-0.2,0.7,0l1.6,1.6c0.2,0.2,0.2,0.5,0,0.7L19.8,30 L5.2,15.4C5,15.2,5,14.8,5.2,14.6z"></path>
      </symbol>
      ...
      <symbol id="icon-52655f31fd82f82d1c86cb188764da1e" viewBox="0 0 40 40">
        <path d="M36.1,21.3c1.5-0.7,1.5-1.9,0-2.6L10.5,6.3C9,5.6,7.8,6.2,7.8,7.6l0,24.8c0,1.4,1.2,2,2.7,1.3L36.1,21.3z"></path>
      </symbol>
    ...
    <div id="wrapper">
      <div id="main">
        <div class="inner">
          <div id="container03" class="container default" style="opacity: 1; transform: none;">
            <div class="wrapper">
              <div class="inner">
                ...
                <p id="text03" class="style1">WhollyAPI - Get Free APIs of Many Website - Public or Scrapped - Use even from JavaScript</p>
                <ul id="buttons03" class="style2 buttons">
                  <li>
                    <a href="#start" class="button n01">
                      <svg>
                        <use xlink:href="#icon-ecbd7520f72820fb3c1bfce19d8ed9ce"></use>
                      </svg>
          ...
          <div id="container01" data-scroll-id="start" data-scroll-behavior="center" data-scroll-offset="0" data-scroll-invisible="1" class="container columns full screen">
            <div class="wrapper">
              <div class="inner" style="opacity: 0; transform: scale(0.9);">
                <div>
                  ...
                  <p id="text02" class="style1">
                    <span class="p">Grabbing Website details - https://wholly-api.000webhostapp.com/get/ <br> Grab Full HTML of Website :- https://wholly-api.000webhostapp.com/get/website-data.php?get_html=https://example.com </span>
                  </p>
                  <ul id="buttons01" class="style2 buttons">
                    <li>
                      <a href="https://www.youtube.com/playlist?list=PLFcP4G5x1z-re4NePDQyPR9_c0L8_tbF0" class="button n01">
                        <svg>
                ...
                <div>
                  ...
                  <p id="text05" class="style1">Custom Website Scrapped APIs</p>
                  <ul id="buttons04" class="style2 buttons">
                    <li>
                      <a href="https://sh20raj.gitbook.io/whollyapi/" class="button n01">
                        <svg>
                          <use xlink:href="#icon-49c7b76f0edfabe10e324ba1ac396f84"></use>
                        </svg>
                        <span class="label">See List</span>
                      </a>
                    </li>
                  </ul>
                </div>
          ...
          <div id="container04" class="container default" style="opacity: 0; transform: translateY(-1.6875rem);">
            <div class="wrapper">
              <div class="inner">
                ...
                <p id="text22" class="style1">Get all related documentations on https://dev.to/whollyapi</p>
                <ul id="buttons07" class="style2 buttons">
                  <li>
                    <a href="https://dev.to/whollyapi" class="button n01">
                      <svg>
          ...
          <div id="container05" class="style1 container default" style="opacity: 0; transform: scale(0.94375);">
            <div class="wrapper">
              <div class="inner">
                <h2 id="text14" class="style3">CXDIIN</h2>
                <p id="text15" class="style1">
                  <span class="p">CXDI - Serve Technology <br> Our one and only aim is to reveal all the useful things on Internet in Front of People . #BeCreative </span>
                </p>
                <ul id="buttons05" class="style2 buttons">
                  <li>
                    <a href="https://codexdindia.blogspot.com/" class="button n01">
                      <svg>
                        <use xlink:href="#icon-0936261325411f95d4c72d19064ecbfc"></use>
                      </svg>
                      <span class="label">CXDI - Serve Technology (◍•ᴗ•◍)</span>
                    </a>
                  </li>
                </ul>
              </div>
          ...
          <div id="container06" class="style1 container default" style="opacity: 0; transform: scale(0.94375);">
            <div class="wrapper">
              <div class="inner">
                <h2 id="text08" class="style3">SopProducts</h2>
                <p id="text09" class="style1">Pellentesque id nibh tortor id aliquet. Nullam ac tortor vitae purus faucibus ornare suspendisse. Nunc lobortis mattis aliquam faucibus.</p>
                <ul id="buttons02" class="style2 buttons">
                  <li>
                    <a href="https://linktr.ee/cxdiin" class="button n01">
                      <svg>
          ...
          <div id="container07" class="container default">
            <div class="wrapper">
              <div class="inner">
                <p id="text06" class="style6">© All rights reserved - SopProducts</p>
              </div>
            </div>
          </div>
